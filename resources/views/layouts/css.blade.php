...
<!-- icheck bootstrap (checkbox/radio enhancements) -->
...
<!-- daterangepicker (depends on Bootstrap styles) -->
<link rel="stylesheet" href="{{ asset('plugins/daterangepicker/daterangepicker.css') }}">

<!-- Tempusdominus Bootstrap 4 (requires Bootstrap 4) -->
